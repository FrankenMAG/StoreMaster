        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CodigoPostalFiscal = table.Column<string>(type: "text", nullable: true),
                    CreadoEn = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    ModificadoEn = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    Eliminado = table.Column<bool>(type: "boolean", nullable: false)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RegimenFiscalEmisor = table.Column<string>(type: "text", nullable: false),
                    RFCReceptor = table.Column<string>(type: "text", nullable: false),
                    NombreReceptor = table.Column<string>(type: "text", nullable: false),
                    RegimenFiscalReceptor = table.Column<string>(type: "text", nullable: false),
                    UsoCFDI = table.Column<string>(type: "text", nullable: false),
                    CodigoPostalReceptor = table.Column<string>(type: "text", nullable: false),
                    Subtotal = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ClaveUnidad = table.Column<string>(type: "text", nullable: false),
                    NoIdentificacion = table.Column<string>(type: "text", nullable: true),
                    ...
                    TasaIVA = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FacturasConcepto_Facturas_FacturaId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FacturasConcepto_FacturaId",
